#################################################################################
######### correlations for SNP rs13337037
...
# regression
glm <- glm(data$stix ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
...
# regression
glm <- glm(data$dw042 ~ data[,"rs13337037_dosage"]) #, family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$water_drinking_freq_j ~ data[,"rs13337037_dosage"]) #, family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$n1010 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e108 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$n1009 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e105 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$r3001 ~ data[,"rs13337037_dosage"]) #, family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$d046 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$d047 ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$gesthyp ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$preeclampsia ~ data[,"rs13337037_dosage"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
dim(table)
# save table
write.table(table, "./other_analysis/regressions/regression_rs13337037_to_trait.txt", 
