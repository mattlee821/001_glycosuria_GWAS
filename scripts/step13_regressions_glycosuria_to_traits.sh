#################################################################################
######### correlations for glycosuria questionnaire
...
# regression
glm <- glm(data$e113 ~ data[,"dw042"], family=binomial(link="logit"))
...
###############################################
### traits correlated to increased blood sugar levels and lead SNP correlation - perform logistic regression of lead SNP against traits correlated to increased blood sugar levels (George = no evidence of association)
...
# regression
glm <- glm(data$e113 ~ data[,"water_drinking_freq_j"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"n1010"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"e108"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"n1009"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"e105"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"r3001"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"d046"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"d047"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"gesthyp"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
# regression
glm <- glm(data$e113 ~ data[,"preeclampsia"], family=binomial(link="logit"))
glm_coef <- summary(glm)$coefficients
glm_coef
summary(glm_coef)
...
dim(table)
# save table
write.table(table, "./other_analysis/regressions/regression_glycosuria_to_trait.txt", 
