...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step4
...
datadir = "./001_glycosuria/reviewer_analysis/GWAS_revision2/step3/output/"
files = list.files(datadir)
w = grep("_snpstats.txt", files)

#### 
dataOUTdir = "./001_glycosuria/reviewer_analysis/GWAS_revision2/step4/output/filter/"
...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step4/output/filter/
mkdir SNP2Keep
for i in *_snpstats*.txt; do echo ${i}; tail -n -2 ${i} | cut -f 2 ${i} > SNP2Keep/${i%.txt}_SNP2Keep.txt; done

cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step4/output
...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step4/output/step2_SNP2KEEP_filter

dir1=./001_glycosuria/reviewer_analysis/GWAS_revision2/step2/output/
dir2=./001_glycosuria/reviewer_analysis/GWAS_revision2/step4/output/filter/SNP2Keep/
...
ls -1 ./001_glycosuria/reviewer_analysis/GWAS_revision2/step2/output > subset_filenames.txt
