...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step9

#run test gwas on single CHR to test
snptest_v2.5.2 -data ./001_glycosuria/reviewer_analysis/GWAS_revision2/step8/output/step2_SNP2KEEP_filter/output/data_chr16_sample_filter_subsetted.bgen ./001_glycosuria/reviewer_analysis/GWAS_revision2/pheno_file/offspring_GWAS/pheno_file_include-list-only.txt -o data_chr16.out -log data_chr16.log -frequentist 1 -method expected -pheno t6001 -cov_names PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 -use_raw_phenotypes
##########################	
...
snptest_v2.5.2 -data ./001_glycosuria/reviewer_analysis/GWAS_revision2/step8/output/step2_SNP2KEEP_filter/output/${VAR1} ./001_glycosuria/reviewer_analysis/GWAS_revision2/pheno_file/offspring_GWAS/pheno_file_include-list-only.txt -o ./001_glycosuria/reviewer_analysis/GWAS_revision2/step9/output/${VAR1%.bgen}.out -log ${VAR1%.bgen}.log -frequentist 1 -method expected -pheno t6001 -cov_names PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 -use_raw_phenotypes
##########################	

#create .txt file of all names for submission scripts based on files in a directory
ls -1 ./001_glycosuria/reviewer_analysis/GWAS_revision2/step8/output/step2_SNP2KEEP_filter/output > data_file_names.txt
...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step9/output
