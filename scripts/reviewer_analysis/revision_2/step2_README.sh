...
cd ./001_glycosuria/reviewer_analysis/GWAS_revision2/step2

dir=./studies/latest/alspac/genetic/variants/arrays/gwas/imputed/1000genomes/released/2015-10-30/data/dosage_bgen
...
qctool -g ${dir}/${VAR1} -s ${dir2}/data.sample -og ${VAR1%.bgen}_sample_filter.bgen -os ${VAR1%.bgen}.sample -incl-samples ${dir1}/pheno_file/include.txt -log ${VAR1%.bgen}_log.txt
############################

#create .txt file of all names for submission scripts based on files in a directory
ls -1 /panfs/panasas01/shared/alspac/studies/latest/alspac/genetic/variants/arrays/gwas/imputed/1000genomes/released/2015-10-30/data/dosage_bgen > bgen_filenames.txt
