...
data <- fread("./001_glycosuria/reviewer_analysis/GWAS_revision2/step9/output/GWAS_output_final.txt", header = T)
names(data)
colnames(data)[2] <- "CHR"
colnames(data)[3] <- "BP"
...
#plot and save
png("./001_glycosuria/reviewer_analysis/GWAS_revision2/step9/plots/manhattan_plot.png",
...
gg.manhattan(df = data, 
             ...
             ylims=c(0,15), #provide minimum and maximum of the Y axis
             title="") 
dev.off()
